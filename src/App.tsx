...
function CounterNum({ value }: { value: number }) {
  ...
  return (
    <span ref={ref} style={{ display: 'inline-block', transition: 'transform 0s' }}>
      {value}
    </span>
  )
}
  ...
  return (
    <>
      <header className="hero-section">
        ...
        <h1>SYSTEM LOG IN</h1>
        <p className="subtitle">Accessing secure data streams. Authorization required.</p>
        
        <button className="btn" onClick={() => setCount((c) => c + 1)}>
          <span>EXECUTE COMMAND [<CounterNum value={count} />]</span>
        ...
        <div className="logos">
          <img src={heroImg} alt="Hero image" className="logo" />
      ...
      <main className="app-container">
        ...
        <section className="terminal-box">
          ...
          <ul className="social-links">
            <li>
              <a href="https://vite.dev/" target="_blank" rel="noreferrer">Explore Vite</a>
            </li>
            <li>
              <a href="https://react.dev/" target="_blank" rel="noreferrer">Learn React</a>
            </li>
          </ul>
        </section>
